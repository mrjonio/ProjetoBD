...
import Restaurante.camadasDeNegocio.interfaces.ICamadaCadapio;
 ...
 *  Implementação da interface ICamadaCadapio.
 */
public class CamadaCardapio implements ICamadaCadapio {
	
	private IRepositorioCardapio repositorioCardapio;
	private static ICamadaCadapio instancia;

	private CamadaCardapio() {
	 ...
	 */
	public static ICamadaCadapio getInstance(){
		if (instancia == null){
			instancia = new CamadaCardapio();
		}
		return instancia;
	}
